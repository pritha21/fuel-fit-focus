        ...
        <div className="space-y-3">
          <div>
            <div className="flex justify-between text-sm mb-1">
              <span>Calories</span>
              <span>
                {Math.round(dailyStats.calories)}/{dailyStats.caloriesGoal}
              </span>
            </div>
          ...
          <div>
            <div className="flex justify-between text-sm mb-1">
              <span>Protein</span>
              <span>
                {Math.round(dailyStats.protein)}g/{dailyStats.proteinGoal}g
              </span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
          ...
          <div>
            <div className="flex justify-between text-sm mb-1">
              <span>Carbs</span>
              <span>
                {Math.round(dailyStats.carbs)}g/{dailyStats.carbsGoal}g
              </span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
          ...
          <div>
            <div className="flex justify-between text-sm mb-1">
              <span>Fat</span>
              <span>
                {Math.round(dailyStats.fat)}g/{dailyStats.fatGoal}g
              </span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
