  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          onClick={onAddFood}
          className="bg-gradient-to-r from-green-400 to-blue-500 text-white p-2 rounded-full hover:from-green-500 hover:to-blue-600 transition-all duration-200 hover:scale-105"
        >
          <Plus size={20} />
        </button>
      </div>
